...
import br.com.survival.core.validation.ValidationException;
import br.com.survival.domain.exception.BusinessException;
import br.com.survival.domain.exception.EntityInUseException;
import br.com.survival.domain.exception.EntityNotFoundException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleAccessDeniedException(AccessDeniedException ex, WebRequest request) {
		...
		ApiError error = createApiErrorBuilder(status, ApiErrorType.ACCESS_DENIED, ex.getMessage())
